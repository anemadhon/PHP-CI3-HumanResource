						...
						<table class="responsive-table table-style mb-a">
							...
							<tbody>
							    ...
							    <tr>
							    	...
							    	<td class="center">
							    		<a href="<?php echo site_url('izin-up/').$ip->id.'/'.$ip->ip ?>"><button type="submit" class="btn-small btn save"><i class="material-icons left">edit</i>Ubah</button></a>
							    	</td>
							    </tr>
							    <tr class="detailview" style="display: none;">
									<td colspan="5">
							    		...
							    		<div class="row">
							    			<div class="col s4 m2">Instansi</div>
							    			<div class="col s5 m5"><span class="truncate">: <?php echo $ip->instansi; ?></span></div>
							    		</div>
							    		<div class="row">
