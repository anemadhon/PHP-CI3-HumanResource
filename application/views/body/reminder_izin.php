		<div class="container-fluid">
			<div class="row">
				...
				<div id="content-bar">
					...
					<div id="content-side">
						<p id="form-title-a">Data Perizinan Yang Mendekati Masa Berakhir</p>
						<p id="form-title-b"><a href="<?php echo site_url('data-izin/display');?>" id="menu-a"><i class="material-icons left">arrow_back</i>Kembali</a></p>
						<div class="row">
							<?php
							foreach ($dataadmin['reminder_izin']->result() as $reminder) {
