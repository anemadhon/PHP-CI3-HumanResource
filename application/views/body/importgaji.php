		<div class="container-fluid">
			<div class="row">
				...
				<div id="content-bar">
					...
					<div id="content-side">
						<p id="form-title-a">Import File - Slip Gaji</p>
						<p id="form-title-b">PT Ghita Avia Trans</p>
						<?php 
						if ($dataadmin['uploaded']->num_rows() == 0 && $this->input->get('kw')==''){ 
							echo form_open_multipart('import','autocomplete="off"'); 
						...
						<div class="row space-btn space mb-a">
					    	<div class="col s12 m6">
					    		<?php echo form_open('slip/pdf','target="_blank"') ?>
									<button type="submit" class="btn save col s12 m3 to-left mb-s"><i class="material-icons left">print</i>Pdf</button>
									<input type="hidden" id="idgaji" name="idgaji">
								<?php echo form_close() ?>
								<?php echo form_open('hapus-gaji') ?>
							...
							<tbody>
							    ...
							    <tr>
							    	<td>
							    		<p>
											<label>
												<input type="checkbox" class="filled-in cb" name="cb[]" value="<?php echo $data->idgaji; ?>">
												<span></span>
											</label>
										</p>
							    	</td>
							    	...
							    	<td class="center">
							    		<a href="<?php echo site_url('cetak-slip/'.$data->idgaji) ?>" target="_blank"><button type="submit" class="btn-small btn save"><i class="material-icons left">print</i>Cetak</button></a>
