			...
			<div class="row">
				...
				<div id="content-bar">
					...
					<div id="content-side">
						...
						<?php
						echo form_open_multipart('legal-izin','autocomplete="off"');
						...
						<div class="row space ml-lg">
							<div class="col s12 m8 l9">
								<div class="row">
							        <div class="col s12">
							        	<input type="text" class="browser-default text-input text-box-input" id="noIP" name="noizinpks" placeholder="No. Surat Perizinan">
							        </div>
								</div>
								<div class="row">
							        <div class="col s12">
						...
						<?php if ($dataadmin['izin']->num_rows() > 0): ?>
						<div class="col s12 m8 l9">
							<div class="row right-align to-left mb-a">
								<a href="<?php echo site_url('data-izin/display');?>" class="to-data"><i class="material-icons right">arrow_forward</i> Lihat Data</a>
							</div>
						</div>
						<?php endif ?>
						<?php
