						...
						?>
					    	<div class="col s12 m6">
					    		<div class="collection space-notif">
									<a href="<?php echo site_url('hbd');?>" class="collection-item"><span class="new badge"><?php echo count($dataultah) ?></span>Notifikasi Ulang Tahun Karyawan</a>
								</div>
					    	</div>
						<?php 
							}
						...
						<div class="row space-btn space mb-a">
					    	<div class="col s12 m6">
							    ...
							    <?php echo form_open('pdf-cv','target="_blank"') ?>
									<button type="submit" class="btn save col s12 m3 mb-s"><i class="material-icons left">print</i>CV</button>
					    	...
					    	<div class="col s12 m6 pad">
								...
								echo form_open('caridata',$attr); ?>
								    ...
								    <select name="urut" id="urut" class="col s12 m4 browser-default select-box-search mb-s">
						...
						<table class="responsive-table table-style mb-a">
							...
							<tbody>
							    ...
							    <tr>
							    	...
							    	<td class="center">
							    		<a href="<?php echo site_url('update/'.$data->ktp) ?>"><button type="submit" class="btn-small btn save"><i class="material-icons left">edit</i>Ubah</button></a>
							    ...
							    <tr class="detailview" style="display: none;">
									<td colspan="10">
										<div class="row">
							    			<div class="col s5 m4">NIK</div>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $data->ktp; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">NPWP</div>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $data->npwp; ?></span></div>
							    		</div>
										<div class="row">
							    			<div class="col s5 m4">TTL</div>
							    			<?php  
							    			...
							    			?>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $t.', '.date_format(date_create($tl), "d-m-Y").' / ('.$data->umur.' Tahun)'; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">Lama Kerja</div>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $lamakerja; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">No. Tlp Aktif</div>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $data->tlp; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">No. Tlp Keluarga</div>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $data->tlpkel; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">Agama</div>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $data->agama; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">Jenis Kelamin</div>
							    			<?php  
							    			if ($data->jk=='1') {
						    					$jk = 'LAKI-LAKI';
						    				} else {
							    			...
							    			?>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $jk; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">Alamat KTP</div>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $data->alamat; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">Alamat Domisili</div>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $data->domisili; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">Ibu Kandung</div>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $data->ibu; ?></span></div>
							    		</div>
							    		<?php if ($data->rek!='' && $data->rek!='-'){ ?>
							    			<div class="row">
								    			<div class="col s5 m4">Ket. Aktif</div>
								    			<div class="col s5 m4"><span class="truncate">: <?php echo $data->rek; ?></span></div>
								    		</div>
							    		<?php } ?>
							    		<?php if ($data->div=='AVSEC'){ ?>
							    			<div class="row">
								    			<div class="col s5 m4">Berlaku Lisensi</div>
								    			<?php  
								    			...
								    			?>
								    			<div class="col s5 m4"><span class="truncate">: <?php echo $lisensi; ?></span></div>
								    		</div>
							    		<?php } ?>
							    		<div class="row">
							    			<div class="col s5 m4">Status Pernikahan</div>
							    			<?php  
							    			if ($data->nikah=='TK') {
						    					$nikah = 'BELUM MENIKAH';
							    			...
							    			?>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $nikah; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">Status Karyawan</div>
							    			<?php  
							    			if ($data->status=='SK1') {
						    					$status = 'AKTIF';
						    				} elseif ($data->status=='SK2') {
							    			...
							    			?>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $status; ?></span></div>
							    		</div>
							    		<div class="row">
							    			<div class="col s5 m4">Pendidikan Terakhir</div>
							    			<div class="col s5 m4"><span class="truncate">: <?php echo $data->ilmu; ?></span></div>
							    		</div>
							    		<?php
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Foto</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $foto ?></span></div>
							    			<?php if ($foto=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/foto-'.$foto);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">KTP</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $ktp ?></span></div>
							    			<?php if ($ktp=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/ktp-'.$ktp);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		<div class="row">
							    			<div class="col s5 m4">NPWP</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $npwp ?></span></div>
							    			<?php if ($npwp=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/npwp-'.$npwp);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">KK</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $kk ?></span></div>
							    			<?php if ($kk=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/kk-'.$kk);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">SKCK</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $skck ?></span></div>
							    			<?php if ($skck=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/skck-'.$skck);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Ijazah</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $ijz ?></span></div>
							    			<?php if ($ijz=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/ijazah-'.$ijz);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Lisensi</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $lisen ?></span></div>
							    			<?php if ($lisen=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/lisensi-'.$lisen);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Sertifikat</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $serti ?></span></div>
							    			<?php if ($serti=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/sertifikat-'.$serti);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Pakta Integritas</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $fakta ?></span></div>
							    			<?php if ($fakta=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/fakta-'.$fakta);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Surat Pengangkatan</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $naik ?></span></div>
							    			<?php if ($naik=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/suratnaik-'.$naik);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Surat Peringatan</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $sp ?></span></div>
							    			<?php if ($sp=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/sp-'.$sp);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Surat Pemberhentian</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $out ?></span></div>
							    			<?php if ($out=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/suratout-'.$out);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Surat Sehat</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $sehat ?></span></div>
							    			<?php if ($sehat=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/suratsehat-'.$sehat);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Pernyataan Bebas Org. Terlarang</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $larang ?></span></div>
							    			<?php if ($larang=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/terlarang-'.$larang);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Surat Referensi</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $ref ?></span></div>
							    			<?php if ($ref=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/referensi-'.$ref);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
							    		...
							    		?>
							    		<div class="row">
							    			<div class="col s5 m4">Surat Terima Karyawan</div>
							    			<div class="col s4 m5 modal-trigger" data-target="modal"><span class="truncate show">: <?php echo $terima ?></span></div>
							    			<?php if ($terima=='kosong'){ ?>
						    					<div class="col s4 m2 right"></div>
						    				<?php } else { ?>
						    					<div class="col s4 m2 right"><a href="<?php echo site_url('download/terima-'.$terima);?>" style="text-decoration: none;color: black;">Download</a></div>
						    				<?php } ?>
