			...
			<div class="row">
				...
				<div id="content-bar">
					...
					<div id="content-side">
						...
						<?php
						echo form_open_multipart('legal-pks-up','autocomplete="off"');
						...
						$up = $dataadmin['izin_pks_up']->row_array();
						...
						<div class="row space ml-lg">
							<div class="col s12 m8 l9">
								<div class="row">
							        <div class="col s12">
							        	<input type="text" class="browser-default text-input text-box-input" id="noIP" name="noizinpks" placeholder="No. PKS" value="<?php echo $up['noip'] ?>" autofocus>
							        </div>
								</div>
								<div class="row">
							        <div class="col s12">
