...
header("Content-Disposition: attachment; filename=Daftar_PKS.xls");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <h3>DAFTAR PKS PT GHITA AVIA TRANS</h3>
    <table border="1">
    	<thead>
            <tr>
                <th>No.</th>
    	...
    	<tbody>
    		...
    		<tr>
    			...
    			<td><?php echo date_format(date_create($excel->tglakhir), "d-m-Y"); ?></td>
    		</tr>
    		<?php 
    		$no++;
    		}
